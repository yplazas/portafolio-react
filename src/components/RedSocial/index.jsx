...
export default function RedSocial() {
  ...
  return (
    <div className="redes-sociales">
      <a
        className="redes-sociales__link dark-theme"
        href="https://github.com/yplazas"
        target="_blank"
      >
      ...
      <a
        className="redes-sociales__link dark-theme"
        href="https://www.linkedin.com/in/yeison-plazas-viloria-971439205/"
        target="_blank"
      >
      ...
      <a
        className="redes-sociales__link dark-theme"
        href="https://twitter.com/YeiAlexPlazas/"
        target="_blank"
      >
